...
export default function CardOrder({
    ...
    const totalAccumulation = () => {
        if(item.delivery_method == 'diantar' && item.delivery_price == 0){
            return <h1 className="font-bold text-red-500">Masih dihitung</h1>
        }
        ...
        const totalAcc = item.delivery_price + item.usage_price + item.total_price

        return <h1 className="font-bold text-xl">{formatCurrency(totalAcc, true)}</h1>
    }
  return (
            ...
            <div className='w-full grid grid-cols-2'>
                <div className="col-span-1">
                    ...
                    <div className="grid grid-cols-12 w-full py-1">
                        ...
                        <div className="col-span-8">
                            <p className="font-semibold whitespace-nowrap">: {item.armada_location}</p>
                        </div>
                    </div>
                    <div className="grid grid-cols-12 w-full py-1">
                        <div className="col-span-4">
