...
export default function OrderCreatePages({
  ...
  return (
    <>
      <Link  href={`/admin/order`}><button type="button" className="flex items-center gap-2 text-primary-500 hover:text-primary-600 duration-300 mb-5 dark:text-white"><Icon icon={IconsCollection['chevron-left']} className="text-xl"/>Back to datatable</button></Link>
      <section className="p-5 shadow-md rounded-md bg-white dark:bg-darkPrimary">
